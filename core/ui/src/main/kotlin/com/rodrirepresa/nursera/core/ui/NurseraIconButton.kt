...
@Composable
private fun NurseraIconButtonPreview() {
    NurseraIconButton(onClick = {}) {
...
@Preview(showBackground = true)
@Composable
private fun NurseraIconButtonPressedPreview() {
    NurseraIconButton(onClick = {}, shadowOffset = 3.dp, backgroundColor = Color(0xFFFF6B6B)) {
